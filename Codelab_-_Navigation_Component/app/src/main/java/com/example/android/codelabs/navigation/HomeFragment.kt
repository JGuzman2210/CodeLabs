...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button?.setOnClickListener{
            //it.findNavController().navigate(R.id.flow_step_two_dest,null,options)
            //this.findNavController().navigate(R.id.flow_step_two_dest,null,options)
            //x -> x.findNavController().navigate(R.id.flow_step_two_dest,null,options)
        ...
        //Navigation.createNavigateOnClickListener(R.id.flow_step_two_dest,null)
